...
function ProjectDetailPage() {
  ...
  return (
    <>
      <section className="relative overflow-hidden border-b border-border py-14 sm:py-18 lg:py-24">
      ...
      <Section tone="surface">
        <SectionHeading
          ...
          title="Envie d'un système équivalent, adapté à votre contexte ?"
          description="Nous commençons toujours par cadrer le problème métier avant de proposer une architecture."
        />
      </Section>
